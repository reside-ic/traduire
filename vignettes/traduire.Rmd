...
then we write an emmitter.  This will append the results to the file if the formatter marked the
...
We could swap out the emmitter to write directly to a database, or to print to screen as well.
